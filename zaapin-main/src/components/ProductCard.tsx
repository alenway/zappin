        ...
        >
            <div className="relative">
                ...
                <button
                    ...
                    className="absolute bottom-3 right-3 bg-orange-500 hover:bg-orange-600 text-white rounded-full p-2 shadow-md transition-opacity opacity-0 group-hover:opacity-100"
                >
